            ...
            <b-row>
              <b-col cols="4">
                <b-button
                  ...
                  variant="primary"
                  type="submit"
                  @click.prevent="changeStatus(SellerDetail.seller_request_id,'Pending')"
                >
                  In Progress
                </b-button>
              </b-col>
              ...
              <b-col cols="4">
                <b-button
                  ...
                  variant="primary"
                  type="submit"
                  @click.prevent="changeStatus(SellerDetail.seller_request_id ,'Approved')"
                >
                  Approved
                </b-button>
              </b-col>
              ...
              <b-col cols="4">
                <b-button
                  ...
                  variant="primary"
                  type="submit"
                  @click.prevent="changeStatus(SellerDetail.seller_request_id ,'Rejected')"
                >
                  Rejected
                </b-button>
              </b-col>
