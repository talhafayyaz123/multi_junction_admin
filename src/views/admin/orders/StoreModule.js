  ...
  actions: {
    ...
    fetchRecords(ctx, queryParams) {
      return new Promise((resolve, reject) => {
        axios
          .get('admin/order', { params: queryParams })
          .then(response => {
    ...
    fetchRecord(ctx, orderNo) {
      return new Promise((resolve, reject) => {
        axios
          .get(`admin/order-detail/${orderNo}`)
          .then(response => {
            ctx.commit('updateRecord', response.data.data.order)
            resolve(response)
          })
          .catch(error => reject(error))
      })
    ...
    changeStatus(ctx, payload) {
      return new Promise((resolve, reject) => {
        axios
          .post('/admin/order/statusChange', payload)
          .then(response => {
